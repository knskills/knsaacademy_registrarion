...
(function () {
    ...
    var usersListUrl = window.location.origin + "/chat/whatsapp/contacts";
    ...
    // get contacts list
    getJSON(contactListUrl, function (err, data) {
        if (err !== null) {
            ...
            var usersList = users.sort(function (a, b) {
            ...
            usersList.forEach(function (user, index) {
                var profilePic = user.profile ? user.profile_pic : dummyImage;
