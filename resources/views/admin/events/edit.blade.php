        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Edit Event Deatil</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('events.update', $event->id) }}" method="post">
                        ...
                        <div class="row">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-8">
                                        <select name="is_active" id="is_active" class="form-select">
                                            <option value="1" {{ $event->is_active == '1' ? 'selected' : '' }}>Yes
                                            </option>
                                            <option value="0" {{ $event->is_active == '0' ? 'selected' : '' }}>No
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-8">
                                        <input type="date" name="event_date" id="event_date"
                                            value="{{ $event->event_date }}" class="form-control">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-8">
                                        <input type="time" name="event_start_time" id="event_start_time"
                                            class="form-control" value="{{ $event->event_start_time }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="whatsapp_link" id="whatsapp_link"
                                            class="form-control" value="{{ $event->whatsapp_link }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="event_duration" id="event_duration"
                                            class="form-control" value="{{ $event->event_duration }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="row mb-2">
                                    <label class="col-md-4 col-form-label">Timer(minutes)</label>
                                    <div class="col-md-8">
                                        <input type="number" name="timer_time" id="timer_time" class="form-control"
                                            value="{{ $event->timer_time }}">
                                    </div>
                                </div>
                            </div>
                        </div>
