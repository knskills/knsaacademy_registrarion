...
@php
    ...
    $startTime = Carbon::parse($event->event_start_time)->format('g A');
    $endTime = Carbon::parse($event->event_end_time)->format('g A');
@endphp
...
@section('title')
    <title>{{ $content->title ?? 'KNSA' }}</title>
@endsection
...
@section('style')
    ...
    <style>
        ...
        .save-my-seat-now-button:hover {
            ...
            /* Darker shade for primary button */
            color: #fff;
        }
...
@section('content')
        ...
        <div class="container" id="top1" style="padding: 20px 0px 70px;">
            <div class="text-center">
                <h2 class="text-white"
                    ...
                    <span
                        class="text-warning font-weight-bold">{{ $content->contanor1_heading ?? 'KNSA' }}</span>
                </h2>

            </div>
            <div class="heading_container heading_center">
                <h2 class="mt-3" id="m1">
                    {{ $content->contanor1_sub_heading ?? 'KNSA' }}
                </h2>
            ...
            <div class="row mt-4">
                @if ($content->contanor1_col1_contant_type == 'image')
                    <div class="col-md-6 mb-4">
                        <img src="{{ asset($content->contanor1_col1_contant) }}"
                            alt="KNSA" class="img-fluid image-effect">
                    </div>
                @else
                    <div class="col-md-6 mb-4">
                        <div class="video-wrapper">
                            <iframe
                                src="{{ $content->contanor1_col1_contant }}"
                                frameborder="0"
                                allow="autoplay; fullscreen; picture-in-picture; clipboard-write"
                                title="KNSA" class="responsive-iframe">
                            </iframe>
                        </div>
                    </div>
                @endif
                ...
                <div class="col-md-6 m-auto">
                        ...
                        <div class="col-6">
                            <div class="h-black m-1">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="m-lg-2" id="seminar-dates">
                                        <span
                                            class="small-text">Date</span><br>
                                        <span
                                            class="big-bold-text seminar-date"
                                            id="next-tuesday">{{ Carbon::parse($event->event_date)->format('j F Y') }}</span>
                    ...
                    <div class="row text-center mt-3">
                        <div class="col-12 text-center p-4">
                            ...
                            <button type="button"
                                class="save-my-seat-now-button payment btn btn-primary">
                                Book Now Your Seat for Just
                                <span
                                    style="font-size: 26px; color: green;">₹{{ intval($event->price) }}!</span>
                                <span
                                    style="color: rgb(196, 9, 9); text-decoration: line-through;">₹{{ intval($event->original_price) }}</span>
                            </button>
                        @else
                            <button type="button"
                                class="save-my-seat-now-button payment btn btn-success">
                                Book Now Your Seat
                                <img src="{{ asset('assets/img/free3.png') }}"
                                    alt="knsa" id="price-img"
                                    class="price-img">
                            </button>
                        @endif
        ...
        <div class="container py-5 text-white">
            <div class="detail-box">
                    ...
                    <div class="col-12 text-center m-auto">
                        <div class="heading_container">
                            <h2 class="text-white"
                                ...
                                {{ $content->contanor2_heading ?? '16 Years of Journey & Achievements' }}
                            </h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-uppercase">
                    @if (
                        !empty($content->contanor2_data) &&
                            count($content->contanor2_data) > 0)
                        @foreach ($content->contanor2_data as $data1)
                            <div class="col-md-3 col-sm-6 mb-4 d-flex m-auto">
                                <div class="card impact-card flex-fill">
                    ...
                    @else
                        ...
                        <div class="col-md-3 col-sm-6 mb-4 d-flex">
                            <div class="card impact-card flex-fill">
                                <h4 class="font-weight-bold m-1"><span
                                        style="color: #FFD700;">5 Lakh+</span>
                                    People Transformed</h4>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 mb-4 d-flex">
                            <div class="card impact-card flex-fill">
                                <h4 class="font-weight-bold"><span
                                        style="color: #FFD700;">1
                                        Million+</span>
                                    Social Media Views</h4>
                            </div>
                        </div>
                    @endif
    ...
    <section class="service_section m-layout">
        <div class="container py-5 text-white">
            <div class="heading_container heading_center mb-3">
                <h2>
                    {{ $content->contanor3_heading ?? 'Proud Moments' }}
                </h2>

                <h4>
                    {{ $content->contanor3_sub_heading ?? 'Proud Moments' }}
                </h4>
            </div>
            <div class="row">
                @if (
                    !empty($content->contanor3_data) &&
                        count($content->contanor3_data) > 0)
                    @foreach ($content->contanor3_data as $data2)
                        <div class="col-md-6 m-auto">
                            <img src="{{ asset($data2) }}" alt="KNSA"
                ...
                @else
                    <div class="col-md-6 m-auto">
                        <img src="{{ asset('assets/img/learning/awards/1.png') }}"
                            alt="KNSA" class="img-fluid award-img">
                    </div>
                    <div class="col-md-6 m-auto">
                    ...
                    <div class="col-md-6 m-auto">
                        <img src="{{ asset('assets/img/learning/awards/3.png') }}"
                            alt="KNSA" class="img-fluid award-img mt-5">
                    </div>
                @endif
            </div>
        </div>
                    ...
                    <div class="detail-box">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-10 m-auto">
                                ...
                                <ul class="mb-4 hindi">
                                    @if (
                                        !empty($content->contanor4_data) &&
                                            count($content->contanor4_data) > 0)
                                        @foreach ($content->contanor4_data as $data3)
                                            <li class="hindi">
                                                👉 {{ $data3 }}
                                            </li>
                                        @endforeach
                                    @else
                                        <li class="hindi">
                                            👉 21वी सदी की क्रांतिकारी बिजनेस
                                            को
                                            जाने, क्यों आपके लिए ये बिजनेस
                                            गोल्डन
                                            ऑपर्च्युनिटी हैं ये समझे और कैसे
                                            बड़ी
                                        ...
                                        <li class="hindi">
                                            👉आप अपनी करियर नेटवर्क मार्केटिंग
                                            में
                                            कई वर्षो से तराश रहे है तो नेटवर्क
                                            मार्केटिंग क्या, की और कैसे आपके
                                            लिए
                                            पहले आई ओपनिंग ट्रेनिंग हो सकता
                                            हैं।
                                        </li>
                                        <li class="hindi">
                                            👉 नेटवर्क मार्केटिंग क्या, क्यों
                                            और
                                            कैसे
                                            एक प्रोफेशनल नेटवर्कर के लिए पहली
                                            टीका
                                            का काम करता हैं।
                                        </li>
                                        <li class="hindi">
                                            👉 पार्ट टाइम काम करके फुल टाइम जॉब
                                            से
    ...
    <section class="service_section m-layout">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                    {{ $content->contanor5_heading ?? 'मुख्य 3 बाते क्यों यह ट्रेनिंग आपके लिए जरूरी हैं –' }}
                </h2>

                <h4>
                    {{ $content->contanor5_sub_heading ?? '' }}
                </h4>
            </div>
            <div class="row">
                @if (
                    !empty($content->contanor5_data) &&
                        count($content->contanor5_data) > 0)
                    @foreach ($content->contanor5_data as $data4)
                        ...
                        <div class="card s_bg">
                            <div class="card-body text-white">
                                <i aria-hidden="true"
                                    class="fas fa-check-circle text-success larger-icon"></i>
                                <span class="f18">
                                    आज बाजार में चैन मार्केटिंग, लोगो को जोड़ने
                                    का
                                    काम, प्रोडक्ट बेचने का काम तरह तरह का
                                    तस्वीर
                                    नेटवर्क मार्केटिंग का बना हुवा हैं, अगर
                                    आपको
                                    नेटवर्क मार्केटिंग की वास्तविक तस्वीर क्या
                                    हैं,
                                    ये जानना है तो ये ट्रेनिंग आपकी मदद कर सकती
                                    है।
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="card s_bg">
                            <div class="card-body text-white">
                                ...
                                <span class="f18">
                                    ...
                                    यानिकि बिना सोचे समझे भीड़ के अनुरूप चलने
                                    की
                                    मनःस्थिति। अधिकांश लोग वैसा ही कर रहे है
                                    जैसा
                                    दूसरे कर रहे हैं, ये जाने समझे बगैर की
                                    क्यों?
                                    नेटवर्क मार्केटिंग क्या, क्यों और कैसे से
                                    आपको
                        ...
                        <div class="card s_bg">
                            <div class="card-body text-white">
                                <i aria-hidden="true"
                                    class="fas fa-check-circle text-success larger-icon"></i>
                                <span class="f18">
                                    आधुनिक दुनिया में किसी भी फील्ड में
                                    प्रोफेशनल
                                    लोग ही ज्यादा पैसा बनाते हैं, प्रोफेशनल का
                                    मतलब
                                    केवल बेहतर Walking, Talking, dressing,
                                    Freshing
                                    नहीं होता, बल्कि अपने प्रोफेशन की प्रोपर
                                    पढ़ाई
                                    लिखाई होती हैं! क्योंकि जब आप पढ़ लिखकर ये
                                    बिजनेस करते हैं तो आपको ये बिजनेस कैसे करना
                                    है
                                    ये स्पष्ट हो जाता हैं। किसी भी बिजनेस के
                                    सिद्धांत स्पष्ट हों जाते है तो काम हमारे
                                    लिए
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="m-lg-2" id="seminar-dates">
                                        ...
                                        <span
                                            ...
                                            id="next-tuesday2">{{ Carbon::parse($event->event_date)->format('j F Y') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- achivers view section -->
    <section class="service_section m-layout">
        <div class="container">
            <div class="heading_container heading_center mb-3">
                <h2>
                    {{ $content->contanor6_heading ?? 'सपनों के सच होने की कहानी' }}
                </h2>
            </div>
            <div class="row">
                @if (
                    !empty($content->contanor6_data) &&
                        count($content->contanor6_data) > 0)
                    @foreach ($content->contanor6_data as $data5)
                        <div class="col-md-6 p-4"><img
                                src="{{ asset($data5) }}" alt="KNSA"
                                class="img-fluid"></div>
                    @endforeach
                @else
                    <div class="col-md-6 p-4"><img
                            src="{{ asset('assets/img/learning/4.jpeg') }}"
                            alt="KNSA" class="img-fluid"></div>
                    <div class="col-md-6 p-4"><img
    ...
    <section class="service_section m-layout">
        <div class="container text-whitw">
            <div class="heading_container heading_center">
                <h2>
                    {{ $content->trainer_heading ?? 'About Trainer' }}
                </h2>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 d-flex flex-column justify-content-center text-white text-center"
                    ...
                    <div class="section-title">
                        <h3>{{ $content->trainer_heading ?? 'Who Is Kamal Narayan Sahu' }}
                        </h3>
                    </div>
                    <ul class="text-left">
                        @if (!empty($content->trainer_data) && count($content->trainer_data) > 0)
                            @foreach ($content->trainer_data as $key => $data6)
                                <li class="mt-2">{{ $key + 1 }})
                                    {{ $data6 }}</li>
                            @endforeach
                        @else
                            <li class="mt-2">
                                1) Youngest CMD in the network
                                marketing industry at 32 years old.</li>
                            <li class="mt-2">
                                2) 16 years of practical
                                experience.</li>
                            <li class="mt-2">
                                3) Successfully led a network
                                company to a 100 crore turnover.</li>
                            <li class="mt-2">
                                4) Author of "Beginner to
                                Billionaire in Network Marketing.
                            </li>
                            <li class="mt-2">
                                5) Turned 14 leaders into
                                crorepatis in just 3 years.
                            </li>
                            <li class="mt-2">
                                6) Recipient of the Visionary
                                Leader of the Year award.
                            </li>
                            <li class="mt-2">
                                7) Featured in a chat with Surender Vats.
                            </li>
                        @endif
                    </ul>
                </div>
                ...
                <div class="col-lg-4 m-auto" data-aos="fade-up"
                    data-aos-delay="100">
                    <img src="{{ asset('assets/img/learning/sir2.webp') }}"
    ...
    <section class="service_section m-layout" style="">
        <div class="container">
            <div class="heading_container heading_center mb-3">
                ...
                @if ($content->bonus_heading)
                    <h2>
                        {{ $content->bonus_heading }}
                    </h2>
                @else
                    <h2>
                        Get Access to <span id="b_price"
                            class="hindi">₹{{ intval($event->bonus_price) }}/</span>
                        -
                        Bonus
                    </h2>
                @endif
            ...
            <div class="row">
                ...
                @if (!empty($content->bonus_data) && count($content->bonus_data) > 0)
                    @foreach ($content->bonus_data as $key => $data7)
                        <div class="col-md-4 m-auto">
                            <div class="card">
                                <img src="{{ asset($data7) }}"
                ...
                @else
                    <div class="col-md-4 m-auto">
                        <div class="card">
                            <img src="{{ asset('assets/img/learning/learn_ebook.webp') }}"
                                alt="knsa" class="img-fluid p-1">
                        </div>
                    </div>
                @endif
                ...
                <div class="row mt-5 m-auto">
                    <div class="col-12 text-center mt-5">
                        ...
                        <p class="text-white mt-3" id="rp">
                            Register today to get a bonus of
                            ₹{{ intval($event->original_price) }}/-
                        </p>
                        ...
                        @if ($content->bonus_sub_heading)
                            <p class="mt-4 text-white">
                                {{ $content->bonus_sub_heading }}</p>
                        @else
                            <p class="mt-4 text-white">एक ऐसे जीवन की कल्पना
                                कीजिए
    ...
    <section class="service_section m-layout">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                    {{ $content->learn_heading ?? 'What will you Learn?' }}
                </h2>

                <h4>
                    {{ $content->learn_sub_heading ?? '' }}
                </h4>
            </div>
            <div class="row mb-3">
                @if (!empty($content->learn_data) && count($content->learn_data) > 0)
                    @foreach ($content->learn_data as $key => $data8)
                    ...
                    <div class="col-md-6 p-2">
                        <div class="card s_bg">
                            <div class="card-body text-white">
                                <i aria-hidden="true"
                                    class="fas fa-check-circle text-success larger-icon"></i>
                                <span class="f18">The true picture of
                                    network
                                    marketing</span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 p-2">
                        <div class="card s_bg">
                            <div class="card-body text-white">
                                <i aria-hidden="true"
                                    class="fas fa-check-circle text-success larger-icon"></i>
                                <span class="f18">Professionalism in
                                    network
                                    marketing</span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 p-2">
                        <div class="card s_bg">
                            <div class="card-body text-white">
                                <i aria-hidden="true"
                                    class="fas fa-check-circle text-success larger-icon"></i>
                                <span class="f18">Why network marketing is
                                    a
    ...
    <section class="service_section m-layout text-white text-center">
        <div class="container">
            <div class="heading_container heading_center">
                ...
                <h3 class="hindi">
                    People earned after learning from our<span
                        class="text-warning">Techniques</span>
                </h3>
                    ...
                    @if ($event->event_type == 'paid')
                        ...
                        <sub>
                            <span class="twt" style="">
                                <del>₹{{ intval($event->original_price) }}</del>
                            </span>
                        </sub>
                    @else
                        <img src="{{ asset('assets/img/free3.png') }}"
                            alt="knsa" class="img-fluid" id="price-img">
                    @endif
                </div>
...
@section('script')
    ...
    <script>
        ...
        const timer_time = {{ $event->timer_time ?? 60 }};

        // Calculate the end time in milliseconds
        const endTime = Date.now() + timer_time * 60 * 1000;
