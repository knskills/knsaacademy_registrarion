...
<div class="chat-leftsidebar">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="pills-user"
            role="tabpanel"
            aria-labelledby="pills-user-tab">
            <!-- Start profile content -->
            <div>
                <div class="user-profile-img">
                    <img src="{{asset('chat/images/4902908.jpg')}}"
                        class="profile-img"
                        style="height: 160px;" alt="">
                    <div class="overlay-content">
                        <div>
                            <div
                                class="user-chat-nav p-2 ps-3">
                ...
                <div
                    class="text-center border-bottom border-bottom-dashed pt-2 pb-4 mt-n5 position-relative">
                    <div class="mb-lg-3 mb-2">
                        <img src="{{asset('chat/images/users/avatar-1.jpg')}}"
                            class="rounded-circle avatar-lg img-thumbnail"
                            alt="">
                    </div>

                    <h5 class="fs-17 mb-1 text-truncate">
                        Dushane Daniel</h5>
                    <p
                        class="text-muted fs-14 text-truncate mb-0">
                ...
                <div class="p-4 profile-desc"
                    ...
                    <div class="text-muted">
                        <p class="mb-3">A professional
                            profile is an introductory
                            section on your resume that
                            highlights your
                    ...
                    <div
                        class="border-bottom border-bottom-dashed mb-4 pb-2">
                        <div
                            class="d-flex py-2 align-items-center">
                            <div
                                class="flex-shrink-0 me-3">
                                <i
                                    class="bx bx-user align-middle text-muted fs-19"></i>
                            </div>
                            <div class="flex-grow-1">
                                <p class="mb-0">Dushane
                                    Daniel</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                class="flex-shrink-0 me-3">
                                <i
                                    class="ri-phone-line align-middle text-muted fs-19"></i>
                            </div>
                            <div class="flex-grow-1">
                                <p class="mb-0">+(365)
                                    1456 12584</p>
                        ...
                        <div
                            ...
                            <div
                                class="flex-shrink-0 me-3">
                                <i
                                    class="ri-message-2-line align-middle text-muted fs-19"></i>
                            </div>
                            <div class="flex-grow-1">
                                <p
                        ...
                        <div
                            ...
                            <div
                                class="flex-shrink-0 me-3">
                                <i
                                    class="ri-map-pin-2-line align-middle text-muted fs-19"></i>
                            </div>
                            <div class="flex-grow-1">
                                <p class="mb-0">
                                    California, USA</p>
                    ...
                    <div
                        class="border-bottom border-bottom-dashed mb-4 pb-4">
                        <div
                            ...
                            <div class="flex-shrink-0">
                                <a href="#"
                                    class="fw-medium fs-12 d-block">Show
                                    all</a>
                            </div>
                        </div>
                        <div class="profile-media-img">
                            <div class="media-img-list">
                                <a href="#">
                                    <img src="{{asset('chat/images/small/img-1.jpg')}}"
                                        alt="media img"
                                        class="img-fluid">
                                </a>
                            </div>
                            <div class="media-img-list">
                                <a href="#">
                                    <img src="{{asset('chat/images/small/img-2.jpg')}}"
                                        alt="media img"
                                        class="img-fluid">
                                </a>
                            </div>
                            <div class="media-img-list">
                                <a href="#">
                                    <img src="{{asset('chat/images/small/img-4.jpg')}}"
                                        alt="media img"
                                        class="img-fluid">
                                    <div
                                        class="bg-overlay">
                        ...
                        <div>
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <img src="{{asset('chat/images/pdf-file.png')}}"
                                            alt=""
                                            class="avatar-xs">
                                    </div>
                                    <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        class="flex-shrink-0 ms-1 me-3">
                                        <img src="{{asset('chat/images/image-file.png')}}"
                                            alt=""
                                            class="avatar-xs">
                                    </div>
                                    <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        class="flex-shrink-0 ms-1 me-3">
                                        <img src="{{asset('chat/images/zip-file.png')}}"
                                            alt=""
                                            class="avatar-xs">
                                    </div>
                                    <div
        ...
        <div class="tab-pane show active" id="pills-chat"
            role="tabpanel"
            ...
            <div>
                <div class="px-4 pt-4">
                    <div
                        ...
                        <div class="flex-grow-1">
                            <h4 class="mb-4">Messages
                                <span
                                    class="text-primary fs-13">(128)</span>
                            </h4>
                        </div>
                    </div>
                    <form>
                        <div
                            class="input-group search-panel mb-3">
                            <input type="text"
        ...
        <div class="tab-pane" id="pills-contacts"
            role="tabpanel"
            ...
            <div>
                <div class="px-4 pt-4">
                    ...
                    <form>
                        <div
                            class="input-group search-panel mb-4">
                            <input type="text"
                                class="form-control bg-light border-0"
                                id="searchContact"
                            ...
                            <button
                                class="btn btn-light p-0"
                                type="button"
                                id="button-searchcontactsaddon"><i
                                    class='bx bx-search align-middle'></i></button>
                        </div>
                    </form>
                </div>
        ...
        <div class="tab-pane" id="pills-calls"
            role="tabpanel"
            ...
            <div>
                ...
                <!-- Start contact lists -->
                <div class="chat-message-list chat-call-list"
                    data-simplebar>
        ...
        <div class="tab-pane" id="pills-bookmark"
            role="tabpanel"
            ...
            <div>
                ...
                <!-- Start contact lists -->
                <div class="chat-message-list chat-bookmark-list"
                    ...
                    <ul class="list-unstyled chat-list">
                        <li>
                            <div
                                ...
                                <div
                                    ...
                                    <p
                                        class="text-muted text-truncate fs-13 mb-0">
                                        12.5 MB</p>
                                </div>
                                ...
                                <div
                                    ...
                                    <div
                                        class="dropdown">
                                        <a class="dropdown-toggle fs-16 text-muted px-1"
                                            href="#"
                                            role="button"
                                            data-bs-toggle="dropdown"
                                            aria-haspopup="true"
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h5
                                        class="fs-14 mb-1">
                                        <a href="#"
                                            class="text-truncate p-0">Images</a>
                                    </h5>
                                    <p
                                        class="text-muted text-truncate fs-13 mb-0">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h5
                                        class="fs-14 mb-1">
                                        <a href="#"
                                            class="text-truncate p-0">analytics
                                            dashboard.zip</a>
                                    </h5>
                                    <p
                                        class="text-muted text-truncate fs-13 mb-0">
                        ...
                        <li>
                            <div
                                ...
                                <div
                                    class="flex-shrink-0 ms-1 me-3">
                                    <img src="/chat/images/txt-file.png"
                                        alt=""
                                        class="avatar-xs">
                                </div>
                                <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h5
                                        class="fs-14 mb-1">
                                        <a href="#"
                                            class="text-truncate p-0">Widgets.zip</a>
                                    </h5>
                                    <p
                                        class="text-muted text-truncate fs-13 mb-0">
                                        6.7 MB</p>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h5
                                        class="fs-14 mb-1">
                                        <a href="#"
                                            class="text-truncate p-0">Image-2.jpg</a>
                                    </h5>
                                    <p
                                        class="text-muted text-truncate fs-13 mb-0">
                                        3.1 MB</p>
        ...
        <div class="tab-pane" id="pills-setting"
            role="tabpanel"
            ...
            <div>
                ...
                <div
                    ...
                    <div class="dropdown d-inline-block">
                        <a class="text-muted dropdown-toggle d-block"
                            href="#" role="button"
                            data-bs-toggle="dropdown"
                            aria-haspopup="true"
                            aria-expanded="false">
                            <i
                                class="bx bxs-circle text-success fs-10 align-middle"></i>
                            Active <i
                    ...
                    <div id="settingprofile"
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header"
                                ...
                                <a class="accordion-button fs-14 fw-medium"
                                    ...
                                    <div
                                        class="d-flex align-items-center">
                                        <div
                                            class="flex-shrink-0 me-3 avatar-xs">
         ...
         text-info text-info rounded">
                            ...
                            <div id="personalinfo"
                                ...
                                <div
                                    class="accordion-body edit-input">
                                    <div
                                        class="float-end">
                                        <a href="#"
                                            class="badge bg-light text-muted"
                                            id="user-profile-edit-btn">
                                            <i class="bx bxs-pencil align-middle"
                                                id="edit-icon"></i>
                                        </a>
                                    </div>
                                    ...
                                    <div class="mt-3">
                                        <label
                                            for="exampleInputPassword1"
                                            class="form-label text-muted fs-13">Phone
                                            No</label>
                                        <input
                                            type="text"
                                            class="form-control"
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header"
                                id="privacy1">
                                <a class="accordion-button fs-14 fw-medium collapsed"
                                    data-bs-toggle="collapse"
                                    href="#privacy"
                                    aria-expanded="false"
         ...
         text-info text-info rounded">
                            ...
                            <div id="privacy"
                                ...
                                <div
                                    ...
                                    <ul
                                        class="list-unstyled vstack gap-4 mb-0">
                                        <li>
                                            <div
                                                class="d-flex align-items-center">
                                                <div
                                                    class="flex-grow-1 overflow-hidden">
                                                    <h5
                                                        class="fs-13 mb-0 text-truncate">
                                                        Profile
                                                        photo
                                                    </h5>
                                                </div>
         ...
         text-info text-info rounded">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header"
                                id="headerhelp">
                                <button
                                    class="accordion-button fs-14 fw-medium collapsed"
                                    type="button"
                                    data-bs-toggle="collapse"
