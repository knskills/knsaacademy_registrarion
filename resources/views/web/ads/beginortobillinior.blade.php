...
@section('script')
    ...
    <script>
        ...
        fbq('init', '901858324954092');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=901858324954092&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-6 justify-content-center hrt">
                    ...
                    <span>
                        ...
                        एक ऐसे जीवन की कल्पना कीजिए जहां आप अपने दिन और समय के मालिक हैं। यह कोर्स आपकी इस कल्पना को हकीकत
                        में बदल देगा।
                    </span>
                ...
                <div class="col-md-6 hrt">
                    ...
                    <div class="tutorial container text-center my-2 ratio ratio-16x9" style="width: 90%;height: 100%;">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up"
                    ...
                    <p class="fst-italic">
                        क्या आप एक सफल नेटवर्क मार्केटिंग व्यवसाय बनाना चाहते हैं? यदि हाँ, तो आपको नेटवर्क मार्केटिंग सफलता
                        सूत्र की आवश्यकता है।
                    </p>

                    <p class="fst-italic">
                        नेटवर्क मार्केटिंग में सफल होने के लिए सबसे ज्यादा काम अपने ऊपर करना होता है, जबकि लोग दूसरों में
                        कमियां निकाल रहे होते हैं, "यह सुनता नहीं है" "वह सुनता नहीं है" अरे वह सुनेगा, उसका खानदान भी
                        सुनेगा, पहले अपने आप को "सुनाने" लायक तो बनाइए।
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up"
                    ...
                    <ul>
                        ...
                        <li>
                            👉 21ST CENTURY की सबसे बड़ी Free Lancing बिजनेस नेटवर्क मार्केटिंग में नई ऊंचाइयों तक पहुंचने
                            के लिए अभी ज्वाइन करे।
                        </li>
                        <li>
                            👉 BEGINNER TO BILLIONAIRE कोर्स श्री कमल नारायण साहू सर के 16 साल के टीम वर्क और लीडरशिप के
                            अनुभव का निचोड़ हैं तभी तो इस कोर्स में आपको मनी बैक गारंटी भी हैं
                        </li>
                    </ul>
