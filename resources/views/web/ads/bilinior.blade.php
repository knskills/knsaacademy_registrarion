...
@section('content')
    ...
    <section class="service_section">
        <div class="container" id="top1" style="padding-bottom: 70px;">
            ...
            <div class="row mt-5">
                <div class="col-md-6">
                    ...
                    {{-- <iframe width="100%" height="100%"
                        src="https://www.youtube.com/embed/6Xr8UZiA7Zg?si=FgHjIjw61Q2FZKdV" title="YouTube video player"
                    ...
                    {{-- <iframe width="560" height="315" src="https://www.youtube.com/embed/6Xr8UZiA7Zg?si=FgHjIjw61Q2FZKdV?frameborder="0"
