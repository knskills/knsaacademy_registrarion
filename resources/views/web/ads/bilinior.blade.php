...
@section('style')
    ...
    <style>
        ...
        .custom-video {
            ...
            height: 100%;
            border-radius: 8px;
            /* Add a border-radius for a softer look */
        ...
        .text-white {
            /* Add your custom styles for the text content here */
            /* Example: */
            padding: 20px;
    ...
    <section class="service_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                ...
                <h3>
                    A 21-Day Challenge by <span class="text-warning">Kamal Narayan Sahu</span>
                </h3>
            </div>
            <div class="row mt-5">
                <div class="col-md-6">
                    <div class="embed-responsive embed-responsive-16by9">
                        <video id="my-video" class="video-js embed-responsive-item custom-video" controls preload="auto"
                            data-setup="{}">
                            <source src="{{ asset('videos/vid.mp4') }}" type="video/mp4" />
                            <source src="{{ asset('videos/vid.mp4') }}" type="video/webm" />
                ...
                <div class="col-md-6 text-white">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus vero, sit sequi, harum odit quos quo
                    atque fugiat rem doloribus quam libero sunt nulla dolor consectetur architecto eius incidunt, quasi
                    voluptas odio officiis. Sunt eos mollitia dolore modi error. Dicta in consectetur, blanditiis veniam
                    quos ab ex fuga expedita praesentium, cupiditate aperiam. Harum architecto quam ipsam nesciunt fuga
                    placeat tempore.
                </div>
            </div>
        </div>
