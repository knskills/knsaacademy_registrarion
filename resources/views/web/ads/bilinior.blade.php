    ...
    <section class="service_section">
        <div class="container" id="top1" style="padding-bottom: 70px;">
            <div class="text-center mt-2">
                <img src="{{asset('assets/img/test.png')}}" alt="kns" class="img-fluid mt-4" height="250px" width="300px">
            </div>
            ...
            <div class="row mt-5">
                <div class="col-md-6">
                    ...
                    <iframe width="560" height="315"
                        src="https://www.youtube.com/embed/6Xr8UZiA7Zg?si=FgHjIjw61Q2FZKdV?rel=0&amp;controls=0"
                        frameborder="2"
